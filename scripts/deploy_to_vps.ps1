...
# Run the VPS environmental setup script we wrote earlier (commented out to speed up subsequent deployments)
# chmod +x /var/www/loot-raiders/scripts/setup_vps.sh
# bash /var/www/loot-raiders/scripts/setup_vps.sh
